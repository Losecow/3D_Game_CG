...
export const FRUIT_DATA = [
  { level: 0, name: '체리',      nameEn: 'Cherry',      radius: 0.48, color: '#FF0000', score: 1,  texture: 'cherry.png'     },
  { level: 1, name: '딸기',      nameEn: 'Strawberry',  radius: 0.70, color: '#FF2255', score: 3,  texture: 'strawberry.png' },
  { level: 2, name: '포도',      nameEn: 'Grape',       radius: 0.95, color: '#8B3FC8', score: 6,  texture: 'grape.png'      },
  { level: 3, name: '귤',        nameEn: 'Dekopon',     radius: 1.25, color: '#FF8C00', score: 10, texture: 'tangerine.png'  },
  { level: 4, name: '감',        nameEn: 'Persimmon',   radius: 1.55, color: '#FF4500', score: 15, texture: 'orange.png'     },
  { level: 5, name: '사과',      nameEn: 'Apple',       radius: 1.90, color: '#228B22', score: 21, texture: 'apple.png'      },
  { level: 6, name: '배',        nameEn: 'Pear',        radius: 2.25, color: '#D4E044', score: 28, texture: 'pear.png'       },
